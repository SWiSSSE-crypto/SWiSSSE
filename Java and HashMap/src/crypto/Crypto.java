...
public class Crypto {
	...
	// SHA1
	public static String SHA1(SecretKeySpec signingKey, String address) throws GeneralSecurityException
	{
		try {
			Mac mac = Mac.getInstance("HmacSHA1");
			mac.init(signingKey);
			return new String(mac.doFinal(address.getBytes()), StandardCharsets.UTF_8);
