...
public class Document {
	...
	public List<Document> split(int document_size)
	{
		...
		document_size = (int) (Math.ceil(16*  keywords_size / (double) document_size) * document_size);
	...
	public String get_string(int document_size)
	{
		...
		document_size = (int) (Math.ceil(result.length() / (double) document_size) * document_size);
