...
public class Crypto {
	...
	// SHA256
	public static byte[] SHA256(SecretKeySpec signingKey, String address) throws GeneralSecurityException
	{
		try {
			Mac mac = Mac.getInstance("HmacSHA256");
			mac.init(signingKey);
			byte[] result_half = Arrays.copyOf(mac.doFinal(address.getBytes()), 16);
			return result_half;
